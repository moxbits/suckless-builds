...
static const Key keys[] = {
  ...
  { ControlMask|ShiftMask,        XK_2,      spawn,          SHCMD("~/.screenlayout/external-monitor-only.sh")},
  { ControlMask|ShiftMask,        XK_3,      spawn,          SHCMD("~/.screenlayout/external-monitor-left.sh")},
  { ControlMask|ShiftMask,        XK_4,      spawn,          SHCMD("~/.screenlayout/external-monitor-right.sh")},
  { MODKEY|ShiftMask,             XK_w,      spawn,          SHCMD("feh --randomize --bg-fill ~/.local/wallpapers/pixelart1")},
  { 0,                            XK_Print,  spawn,          SHCMD("maim ~/pictures/screenshots/screenshot_$(date +%s).png") },
  { ShiftMask,                    XK_Print,  spawn,          SHCMD("maim -s ~/pictures/screenshots/screenshot_$(date +%s).png") },
